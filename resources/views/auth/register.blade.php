                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="middle_initials" type="text" class="form-control @error('middle_initials') is-invalid @enderror" name="middle_initials" value="{{ old('middle_initials') }}" autocomplete="middle_initials" autofocus>

                                @error('middle_initials')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
